...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.personinfo_cb = QtWidgets.QComboBox(self.centralwidget)
        self.personinfo_cb.setGeometry(QtCore.QRect(260, 320, 211, 31))
        self.personinfo_cb.setObjectName("personinfo_cb")
        self.namecorrection_cb = QtWidgets.QComboBox(self.centralwidget)
        self.namecorrection_cb.setGeometry(QtCore.QRect(260, 430, 211, 31))
        self.namecorrection_cb.setObjectName("namecorrection_cb")
        self.start_btn = QtWidgets.QPushButton(self.centralwidget)
        self.start_btn.setGeometry(QtCore.QRect(660, 510, 93, 28))
        self.start_btn.setObjectName("start_btn")
        self.label_6 = QtWidgets.QLabel(self.centralwidget)
        self.label_6.setGeometry(QtCore.QRect(130, 220, 91, 16))
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(self.centralwidget)
        self.label_7.setGeometry(QtCore.QRect(130, 330, 91, 16))
        self.label_7.setObjectName("label_7")
        self.label_8 = QtWidgets.QLabel(self.centralwidget)
        self.label_8.setGeometry(QtCore.QRect(130, 440, 111, 20))
        self.label_8.setObjectName("label_8")
        self.personinfo_btn = QtWidgets.QPushButton(self.centralwidget)
        self.personinfo_btn.setGeometry(QtCore.QRect(687, 266, 93, 28))
        self.personinfo_btn.setObjectName("personinfo_btn")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(50, 270, 49, 16))
        self.label_4.setObjectName("label_4")
        self.namecorrection_btn = QtWidgets.QPushButton(self.centralwidget)
        self.namecorrection_btn.setGeometry(QtCore.QRect(690, 380, 93, 28))
        self.namecorrection_btn.setObjectName("namecorrection_btn")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(18, 380, 81, 20))
        ...
        self.namecorrection.setGeometry(QtCore.QRect(120, 370, 551, 41))
        ...
        self.personinfo.setGeometry(QtCore.QRect(119, 261, 551, 39))
        ...
        self.personinfo_btn.clicked.connect(self.personinfo_click)
        self.personinfo_cb.currentTextChanged['QString'].connect(self.personinfo_cb_click)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "人資表分頁:"))
        self.label_8.setText(_translate("MainWindow", "姓名更正表分頁:"))
        self.personinfo_btn.setText(_translate("MainWindow", "瀏覽"))
        self.label_4.setText(_translate("MainWindow", "人資表:"))
